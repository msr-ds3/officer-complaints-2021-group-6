...
# View(nyc_incidents_with_specific_columns)
...
First, we analyzed the percentage of cases by impacted males for which action was taken versus the percentage of cases by impacted males for which no action was taken as compared with  the percentage of cases by impacted females for which action was taken versus the percentage of cases by impacted females for which no action was taken. In other words, we analyzed the percentage of cases for which action was taken versus the percentage of cases for which no action was taken, given that the impacted person was a male, as compared with the percentage of cases for which action was taken versus the percentage of cases for which no action was taken, given that the impacted person was a female. 

```{r action taken vs no action taken by gender}
...
# View(nyc_incidents_by_impacted_gender)
...
# View(nyc_incidents_by_impacted_males)
...
View(nyc_incidents_by_impacted_females)
...
Next, we analyzed the proportion of cases for impacted people of each gender with action versus no action divided also by the gender of the offending officer. 
...
```{r action and no action by impacted gender and officer gender}
...
nyc_incidents_by_impacted_gender_and_officer_gender <- 
  ...
  summarize(num_in_this_category = n())
# View(nyc_incidents_by_impacted_gender_and_officer_gender)
...
# View(impacted_male_and_officer_gender)
...
impacted_female_and_officer_gender <- 
  ...
  # calculate the proportion
  mutate(proportion_in_this_category = num_in_this_category / sum(num_in_this_category))
# View(impacted_female_and_officer_gender)
