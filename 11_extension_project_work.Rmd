...
Next, we analyzed the proportion of complaints filed by people of each gender with a sustained finding versus no sustained finding depending also on the sex of the offending officer. As indicated in the table and the graphs below, these percentages were very similar between the genders. In other words, the sex of the offending officer did not seem to play a role in whether or not a finding was sustained regardlesss of whether a complaint was filed by a male or a female.
